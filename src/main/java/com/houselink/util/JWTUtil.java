package com.houselink.util;

import java.io.UnsupportedEncodingException;
import java.util.Date;
import java.util.Map;

import com.houselink.exception.UnAuthorizedException;
...
//		저장할 data의 key, value
		...
		String jwt = Jwts.builder()
				.setHeaderParam("typ", "Bearer").setClaims(claims) // Header 설정 : 토큰의 타입, 해쉬 알고리즘 정보 세팅.
...
//			parseClaimsJws : 파싱하여 원본 jws 만들기;
			Jws<Claims> claims = Jwts.parser().setSigningKey(this.generateKey()).parseClaimsJws(token.substring(7));
